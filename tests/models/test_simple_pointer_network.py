...
def test_sciarg_predict(trained_model, sciarg_batch, sciarg_batch_predictions, loaded_taskmodule):
    ...
    assert dict(fp) == {
        "labeled_spans": {
            ...
            LabeledSpan(start=705, end=691, label="background_claim", score=1.0),
            ...
            LabeledSpan(start=759, end=761, label="own_claim", score=1.0),
            LabeledSpan(start=984, end=864, label="own_claim", score=1.0),
            ...
            LabeledSpan(start=90, end=95, label="background_claim", score=1.0),
            ...
            LabeledSpan(start=747, end=756, label="data", score=1.0),
            LabeledSpan(start=70, end=78, label="data", score=1.0),
            LabeledSpan(start=169, end=170, label="data", score=1.0),
            LabeledSpan(start=618, end=570, label="own_claim", score=1.0),
            LabeledSpan(start=127, end=126, label="background_claim", score=1.0),
            ...
            LabeledSpan(start=667, end=674, label="background_claim", score=1.0),
        ...
        "binary_relations": {
            ...
            BinaryRelation(
                ...
                tail=LabeledSpan(start=182, end=188, label="background_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
            ...
            BinaryRelation(
                ...
                tail=LabeledSpan(start=380, end=386, label="own_claim", score=1.0),
                label="parts_of_same",
                score=1.0,
            ),
            BinaryRelation(
                head=LabeledSpan(start=533, end=556, label="own_claim", score=1.0),
            ...
            BinaryRelation(
                head=LabeledSpan(start=90, end=95, label="background_claim", score=1.0),
            ...
            BinaryRelation(
                head=LabeledSpan(start=759, end=761, label="own_claim", score=1.0),
            ...
            BinaryRelation(
                head=LabeledSpan(start=747, end=756, label="data", score=1.0),
                tail=LabeledSpan(start=719, end=734, label="own_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
                head=LabeledSpan(start=227, end=235, label="own_claim", score=1.0),
                tail=LabeledSpan(start=212, end=219, label="own_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            ...
            BinaryRelation(
                head=LabeledSpan(start=639, end=666, label="data", score=1.0),
                tail=LabeledSpan(start=667, end=674, label="background_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
