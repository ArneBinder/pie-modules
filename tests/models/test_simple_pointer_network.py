...
def test_sciarg_predict(trained_model, sciarg_batch, sciarg_batch_predictions, loaded_taskmodule):
    ...
    assert dict(fp) == {
        "labeled_spans": {
            ...
            LabeledSpan(start=776, end=787, label="own_claim", score=1.0),
            ...
            LabeledSpan(start=372, end=407, label="data", score=1.0),
            ...
            LabeledSpan(start=680, end=691, label="background_claim", score=1.0),
            ...
            LabeledSpan(start=619, end=634, label="background_claim", score=1.0),
            LabeledSpan(start=53, end=87, label="background_claim", score=1.0),
            ...
            LabeledSpan(start=221, end=222, label="data", score=1.0),
        ...
        "binary_relations": {
            ...
            BinaryRelation(
                head=LabeledSpan(start=372, end=407, label="data", score=1.0),
            ...
            BinaryRelation(
                head=LabeledSpan(start=697, end=717, label="own_claim", score=1.0),
                tail=LabeledSpan(start=680, end=691, label="background_claim", score=1.0),
                label="contradicts",
                score=1.0,
            ),
            BinaryRelation(
            ...
            BinaryRelation(
                ...
                tail=LabeledSpan(start=53, end=87, label="background_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
            ...
            BinaryRelation(
                head=LabeledSpan(start=619, end=634, label="background_claim", score=1.0),
                tail=LabeledSpan(start=607, end=617, label="own_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
                head=LabeledSpan(start=776, end=787, label="own_claim", score=1.0),
            ...
            BinaryRelation(
                head=LabeledSpan(start=221, end=222, label="data", score=1.0),
