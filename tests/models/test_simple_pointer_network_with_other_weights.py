...
def test_sciarg_predict_with_weights_from_other_model(
    ...
    assert dict(fp) == {
        "labeled_spans": {
            ...
            LabeledSpan(start=544, end=576, label="own_claim", score=1.0),
            LabeledSpan(start=489, end=490, label="data", score=1.0),
            LabeledSpan(start=456, end=471, label="background_claim", score=1.0),
            LabeledSpan(start=326, end=350, label="own_claim", score=1.0),
            LabeledSpan(start=454, end=475, label="own_claim", score=1.0),
            ...
            LabeledSpan(start=539, end=541, label="data", score=1.0),
            LabeledSpan(start=153, end=174, label="own_claim", score=1.0),
            LabeledSpan(start=719, end=734, label="own_claim", score=1.0),
            LabeledSpan(start=310, end=322, label="own_claim", score=1.0),
            LabeledSpan(start=-8, end=728, label="own_claim", score=1.0),
            LabeledSpan(start=221, end=225, label="data", score=1.0),
            LabeledSpan(start=605, end=615, label="background_claim", score=1.0),
            LabeledSpan(start=388, end=389, label="data", score=1.0),
            LabeledSpan(start=514, end=527, label="own_claim", score=1.0),
            LabeledSpan(start=290, end=305, label="own_claim", score=1.0),
            ...
            LabeledSpan(start=352, end=365, label="own_claim", score=1.0),
            LabeledSpan(start=476, end=485, label="own_claim", score=1.0),
            LabeledSpan(start=219, end=232, label="data", score=1.0),
            LabeledSpan(start=407, end=432, label="own_claim", score=1.0),
            LabeledSpan(start=192, end=193, label="background_claim", score=1.0),
            LabeledSpan(start=491, end=498, label="own_claim", score=1.0),
            LabeledSpan(start=136, end=148, label="background_claim", score=1.0),
            LabeledSpan(start=387, end=407, label="background_claim", score=1.0),
            LabeledSpan(start=372, end=376, label="data", score=1.0),
            LabeledSpan(start=310, end=456, label="own_claim", score=1.0),
            ...
            LabeledSpan(start=107, end=126, label="own_claim", score=1.0),
            LabeledSpan(start=212, end=219, label="own_claim", score=1.0),
            LabeledSpan(start=639, end=674, label="own_claim", score=1.0),
            ...
            LabeledSpan(start=539, end=544, label="data", score=1.0),
            LabeledSpan(start=427, end=439, label="data", score=1.0),
            ...
            LabeledSpan(start=411, end=441, label="own_claim", score=1.0),
            LabeledSpan(start=384, end=387, label="background_claim", score=1.0),
            LabeledSpan(start=127, end=144, label="own_claim", score=1.0),
            LabeledSpan(start=307, end=308, label="data", score=1.0),
            LabeledSpan(start=342, end=349, label="data", score=1.0),
        },
        "binary_relations": {
            BinaryRelation(
                head=LabeledSpan(start=219, end=232, label="data", score=1.0),
                tail=LabeledSpan(start=233, end=253, label="own_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
                head=LabeledSpan(start=443, end=453, label="own_claim", score=1.0),
                tail=LabeledSpan(start=411, end=441, label="own_claim", score=1.0),
                label="contradicts",
                score=1.0,
            ),
            BinaryRelation(
                head=LabeledSpan(start=326, end=350, label="own_claim", score=1.0),
                tail=LabeledSpan(start=352, end=365, label="own_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
            ...
            BinaryRelation(
                head=LabeledSpan(start=512, end=516, label="own_claim", score=1.0),
            ...
            BinaryRelation(
                head=LabeledSpan(start=342, end=349, label="data", score=1.0),
            ...
            BinaryRelation(
                ...
                tail=LabeledSpan(start=192, end=193, label="background_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
                head=LabeledSpan(start=427, end=439, label="data", score=1.0),
                tail=LabeledSpan(start=408, end=423, label="background_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
            ...
            BinaryRelation(
                ...
                tail=LabeledSpan(start=476, end=485, label="own_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
                head=LabeledSpan(start=539, end=544, label="data", score=1.0),
                tail=LabeledSpan(start=544, end=576, label="own_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
            ...
            BinaryRelation(
                head=LabeledSpan(start=127, end=144, label="own_claim", score=1.0),
                tail=LabeledSpan(start=107, end=126, label="own_claim", score=1.0),
                label="parts_of_same",
                score=1.0,
            ),
            BinaryRelation(
            ...
            BinaryRelation(
                ...
                tail=LabeledSpan(start=290, end=305, label="own_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
                head=LabeledSpan(start=489, end=490, label="data", score=1.0),
                tail=LabeledSpan(start=454, end=475, label="own_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
                head=LabeledSpan(start=639, end=674, label="own_claim", score=1.0),
                tail=LabeledSpan(start=675, end=691, label="own_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
                head=LabeledSpan(start=605, end=615, label="background_claim", score=1.0),
                tail=LabeledSpan(start=387, end=407, label="background_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
            ...
            BinaryRelation(
                head=LabeledSpan(start=-8, end=728, label="own_claim", score=1.0),
                tail=LabeledSpan(start=692, end=728, label="own_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
                head=LabeledSpan(start=324, end=325, label="data", score=1.0),
                tail=LabeledSpan(start=310, end=322, label="own_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
                head=LabeledSpan(start=310, end=456, label="own_claim", score=1.0),
                tail=LabeledSpan(start=457, end=466, label="own_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
            ...
            BinaryRelation(
                ...
                tail=LabeledSpan(start=456, end=471, label="background_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
                head=LabeledSpan(start=539, end=541, label="data", score=1.0),
                tail=LabeledSpan(start=719, end=734, label="own_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
                head=LabeledSpan(start=491, end=498, label="own_claim", score=1.0),
                tail=LabeledSpan(start=514, end=527, label="own_claim", score=1.0),
                label="parts_of_same",
                score=1.0,
            ),
        },
