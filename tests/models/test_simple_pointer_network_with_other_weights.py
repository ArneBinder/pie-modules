...
def test_sciarg_predict_with_weights_from_other_model(
    ...
    assert dict(fp) == {
        "labeled_spans": {
            ...
            LabeledSpan(start=106, end=108, label="own_claim", score=1.0),
            ...
            LabeledSpan(start=601, end=615, label="background_claim", score=1.0),
            ...
            LabeledSpan(start=109, end=123, label="own_claim", score=1.0),
            ...
            LabeledSpan(start=91, end=105, label="data", score=1.0),
            ...
            LabeledSpan(start=568, end=570, label="background_claim", score=1.0),
        ...
        "binary_relations": {
            ...
            BinaryRelation(
                head=LabeledSpan(start=568, end=570, label="background_claim", score=1.0),
            ...
            BinaryRelation(
                head=LabeledSpan(start=91, end=105, label="data", score=1.0),
                tail=LabeledSpan(start=106, end=108, label="own_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
                head=LabeledSpan(start=106, end=108, label="own_claim", score=1.0),
                tail=LabeledSpan(start=109, end=123, label="own_claim", score=1.0),
                label="parts_of_same",
                score=1.0,
            ),
            BinaryRelation(
