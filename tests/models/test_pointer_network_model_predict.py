...
def test_sciarg_predict(trained_model, sciarg_batch, loaded_taskmodule):
    ...
    assert dict(fp) == {
        "labeled_spans": {
            ...
            LabeledSpan(start=528, end=576, label="own_claim", score=1.0),
            LabeledSpan(start=233, end=350, label="background_claim", score=1.0),
        ...
        "binary_relations": {
            ...
            BinaryRelation(
                ...
                tail=LabeledSpan(start=528, end=576, label="own_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
            ...
            BinaryRelation(
                ...
                tail=LabeledSpan(start=233, end=350, label="background_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
