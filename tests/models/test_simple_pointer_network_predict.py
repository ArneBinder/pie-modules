...
def test_sciarg_predict(trained_model, sciarg_batch, loaded_taskmodule):
    ...
    assert dict(fp) == {
        "labeled_spans": {
            ...
            LabeledSpan(start=815, end=824, label="own_claim", score=1.0),
            LabeledSpan(start=589, end=606, label="own_claim", score=1.0),
            LabeledSpan(start=227, end=235, label="own_claim", score=1.0),
            LabeledSpan(start=906, end=1000, label="own_claim", score=1.0),
            ...
            LabeledSpan(start=404, end=428, label="background_claim", score=1.0),
            ...
            LabeledSpan(start=639, end=633, label="own_claim", score=1.0),
        ...
        "binary_relations": {
            ...
            BinaryRelation(
                ...
                tail=LabeledSpan(start=761, end=775, label="own_claim", score=1.0),
                label="supports",
                score=1.0,
            ),
            BinaryRelation(
            ...
            BinaryRelation(
                head=LabeledSpan(start=815, end=824, label="own_claim", score=1.0),
                tail=LabeledSpan(start=799, end=814, label="own_claim", score=1.0),
                label="parts_of_same",
                score=1.0,
            ),
