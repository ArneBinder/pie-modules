from typing import Any, Dict, MutableMapping, Optional, Tuple, Type, TypeVar, Union
...
def flatten_nested_dict(d: MutableMapping, parent_key: str = "", sep: str = "/") -> Dict[str, Any]:
